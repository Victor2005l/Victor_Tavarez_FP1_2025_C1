...
{
    int i;
    char cad0[20] = "Hola M�xico"; // Comillas corregidas
    char cad1[20] = "Hola Guatemala"; // Comillas corregidas
    char cad2[20] = "Hola Venezuela"; // Comillas corregidas
    char cad3[20] = "Hola M�xico"; // Comillas corregidas
    char *c, c3;
