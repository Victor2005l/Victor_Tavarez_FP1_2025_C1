...
void main(void)
{
    ...
    /* Se abre el archivo para escritura. En la misma instrucci�n se verifica si se pudo abrir. */
    {
        ...
        while (res)
        {
            fflush(stdin); // Limpia el b�fer de entrada (aunque no est�ndar, funciona en algunos compiladores)
            printf("Ingrese la cadena: ");
            gets(cad); // Funci�n insegura pero mantenida como en el original
