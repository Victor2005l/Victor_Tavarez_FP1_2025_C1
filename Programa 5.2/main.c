...
/* Elecci�n.
El programa almacena los votos emitidos en una eleccion en la que cinco candidatos e imprime el total de votos
...
void main(void)
{
    ...
    while (VOT)
    {
        if ((VOT > 0) && (VOT < 6)) /* Se verifica que el voto sea correcto. */
          ...
          del arreglo es 0, por esa raz�n a la variable VOT se le descuenta 1. Los votos del primer
          candidato se almacenan en la posici�n 0. */
