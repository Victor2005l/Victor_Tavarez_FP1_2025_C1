...
void main(void)
{
    ...
    while (FIL > MAX || FIL < 1); /* Se verifica que el n�mero de filas sea correcto. */
    ...
    while (COL > MAX || COL < 1); /* Se verifica que el n�mero de columnas sea correcto. */
...
/* Esta funci�n se utiliza para una matriz de tipo entero de F filas y C
columnas. */
{
    int I, J;
    for (I = 0; I < F; I++)
